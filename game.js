...
export class Game {
  ...
  /**
   * This method checks if all the squares on the board are filled and returns a message indicating whether the player has won the game or not.
   * @returns {string} A message indicating whether the player has won the game or not.
   */
  checkIfPlayerWon() {
    ...
    if (isBoardFull) {
      return 'Congratulations! You have filled up all the squares and won the game!';
    } else {
      return 'You have not filled up all the squares yet. Keep playing!';
    }
  }
